...
public class OverlayService extends Service {
    ...
    public void onCreate() {
        ...
        WindowManager.LayoutParams params = new WindowManager.LayoutParams(
                WindowManager.LayoutParams.MATCH_PARENT, // Width: fullscreen
                WindowManager.LayoutParams.MATCH_PARENT, // Height: fullscreen
                ...
                WindowManager.LayoutParams.FLAG_FULLSCREEN // Hide status bar
                        | WindowManager.LayoutParams.FLAG_LAYOUT_IN_SCREEN // Extend into system UI areas
                        | WindowManager.LayoutParams.FLAG_LAYOUT_INSET_DECOR // Adjust for insets
...
//        NavigationUtility.setNavigation(this,dismissButton,Dashboard.class);
